...
from .._dicom_io import create_dataset_summary_for_agora
...
def _run(args):
    ...
    data = create_dataset_summary_for_agora(args.project,
                                            args.url,
                                            args.api_key)
...
def _parse_args():
    ...
    parser_group.add_argument("-u", "--url", required=True, type=str,
                              help="The Agora url")
    parser_group.add_argument("-k", "--api-key", required=True, type=str,
                              help="The Agora api key")
    parser_group.add_argument("-p", "--project", type=int, required=True,
                              help="The agora project id")
